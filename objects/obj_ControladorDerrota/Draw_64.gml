...
var titulo_x = display_get_gui_width() / 2;
var titulo_y = display_get_gui_height() / 2 + 100; // abaixo do centro
...
var fala_y = display_get_gui_height() - 240; // ajuste vertical
var largura_max = display_get_gui_width() - fala_x * 2;
