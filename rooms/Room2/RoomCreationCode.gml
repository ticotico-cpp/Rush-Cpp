...
var gato = instance_create_layer(room_width * -0.01, room_height * 0.50, "Instances", obj_GatoIdle);
gato.image_xscale = 1; // mantém o lado normal

// Pato: canto direito, um pouco abaixo do centro
var pato = instance_create_layer(room_width * 0.90, room_height * 0.68, "Instances", obj_PatoIdle);
